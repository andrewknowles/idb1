...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2015 at 05:14 PM
...
(61, 'PO Invoices with Date &gt; Today', 'select count(*) cnt from sih, sid where sih_d_inv > current and sih.sih_id = sid.sih_id\r\n', 'and sih.bra_id = ?', 'and sih.cpy_id = ?', 1, 14, 0, 62),
(62, 'PO Invoices with Date &gt; Today', 'select spp_id, sih_matchname, bra_id, dpr_id, sih_doc_id, sih_d_inv, sid_d_due from sih, sid where sih_d_inv > current and sih.sih_id = sid.sih_id', 'and sih.bra_id = ? order by bra_id, dpr_id', 'and sih.cpy_id = ? order by bra_id, dpr_id', 2, 14, 0, 0),
...
(65, 'PO Invoice value &lt;&gt; AP register', 'select sih_total_cur, gir_id, sih.cur_id, sih.sih_id, gir.gir_id,  sih_doc_id, gir_doc_id, sih_total_cur, gir_amt_cur, sih_tax_cur,  gir_amt_tax  from sih, gir\r\nWHERE sih.sih_inv_id = gir.gir_inv_id AND gir.spp_id = sih.spp_id AND gir.cpy_id = sih.cpy_id\r\nand (sih_total_cur <> gir_amt_cur or sih_tax_cur <> gir_amt_tax)\r\n', 'and sih.bra_id = ?', 'and sih.cpy_id = ?', 32, 3, 0, 0),
...
(70, 'x', 'x', 'x', 'x', 999, 0, 0, 0),
(71, 'x', 'x', 'x', 'x', 999, 0, 0, 0),
(72, 'x', 'x', 'x', 'x', 999, 0, 0, 0);
